  ...
  return (
    <div className={cn('relative w-full', className, isOpen ? 'z-500' : 'z-0')} ref={containerRef}>
      <button
        ...
        className={cn(
          'flex w-full cursor-pointer items-center justify-between rounded-xl border px-4 py-3.5 text-left text-sm transition-all duration-200 outline-none focus:ring-2',
          styles.input,
          isOpen ? 'ring-2' : ''
        )}
      >
